...
<table class="table">
    ...
    <tbody>
    <c:forEach items="${listSinhVien}" varStatus="i" var="sinhVien">
        <tr>
            <td>${i.index}</td>
            <td>${sinhVien.id}</td>
            ...
            <td>
                <a class="btn btn-danger" href="/sinh-vien/delete?id=${sinhVien.id}">xoa</a>
                <a class="btn btn-warning" href="/sinh-vien/edit?id=${sinhVien.id}">edit</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
